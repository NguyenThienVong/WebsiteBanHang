	...
	<div class="wrapper">
		...
		<div
			...
			<img class="animation__shake"
				src="<c:url value='/Template/Admin/dist/img/logobongda.png'/>" height="60"
				width="60">
		</div>
			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item"><a class="nav-link"
					data-widget="fullscreen" href="#" role="button"> <i
						class="fa fa-gamepad" aria-hidden="true"></i>
				</a></li>
				<li class="nav-item"><a class="nav-link"
					data-widget="control-sidebar" data-controlsidebar-slide="true"
					href="#" role="button"> <i class="fa fa-gamepad" aria-hidden="true"></i>
				</a></li>
			</ul>
		</nav>
		<!-- /.navbar -->
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="admin" class="brand-link"><img
				src="<c:url value='/Template/User/img/logobongda.png'/>"
