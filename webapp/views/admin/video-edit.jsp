  ...
  <!-- Preloader -->
	<div
			...
			<img class="animation__shake"
				src="<c:url value='/Template/Admin/dist/img/logobongda.png'/>"
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    	<a href="admin" class="brand-link"> 
			<img src="<c:url value='/Template/User/img/logobongda.png'/>" class="brand-image img-circle elevation-3" style="opacity: .8"> 
			<span class="font-weight-light">𝓝𝓮𝔂𝓶𝓪𝓻</span>
			</a>
      ...
      <div class="row">
        <div class="col-md-12">
      	...
      	<div class="row" style="margin: auto auto;">
			<button type="button" id="resetBtn" class="p-3 mb-2 bg-danger text-white" style="margin-right: 15px;">Reset</button>
			<button type="button" id="submitBtn" class="p-3 mb-2 bg-info text-white">Submit</button>
		</div>
